...
public partial class RoasteringOffLeaveAdjustment : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!(IsPostBack))
        {
            ...
            DataTable DT = command.ExecuteQuery(" FetchRemainingRoasteringOffBalance '" + Request.QueryString["EmpCode"].ToString() + "','" + Request.QueryString["E"].ToString() + "'");
    ...
    protected void btnValidate_Click(object sender, EventArgs e)
    {
        ...
        if (TotalSelectedHours == Convert.ToUInt32(lblRequestedHour.Text))
        {
            ...
            command.ExecuteQuery("UpdateLockRoasteringOffRows '" + IDs + "'");
            Session[SessionName] = IDsWithHours;

            lblMessage.Text = "Roastering Off Adjustment Validated";
        }
        else
        {
            lblMessage.Text = "Invalid Roastering Off Adjustment. Please Check Requested Hour And Selected Hour.";
        }
    }
