<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPageNew.master" AutoEventWireup="true"
    CodeFile="MusterRollManager.aspx.cs" Inherits="MusterRollManager" Title="Master Roll For Manager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="text-align: center" colspan="2">
                                                ...
                                                <asp:Button ID="btnSendMail" runat="server" OnClick="btnSendMail_Click" Text="Send Mail To All Team Member" Visible="False" /></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                    ...
                    <tr>
                        <td>
                            <div id="aa" style="overflow: auto;">
                                <fieldset style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 5px">
                                    <asp:GridView ID="divReport" runat="server" Width="100%" OnRowDataBound="divReport_RowDataBound">
                                    </asp:GridView>
                                </fieldset>
                            </div>
                        </td>
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.getElementById('<%= hfWidth.ClientID %>').value = GetBrowserWidth() - 30 
    </script>
