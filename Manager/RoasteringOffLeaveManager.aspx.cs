...
public partial class CompensatoryLeaveManager : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        SqlCommand Com = new SqlCommand("[FetchEmployeeListForManagerApprovalRoasteringOff]", conStr);
        ...
        try
        {
            ...
            {
                Hide.Visible = false;
                Error.InnerHtml = "No Roastering Leave Pending For Approval.";
            }
        }
        catch (Exception ee)
        {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlConnection conStr = connection.CreateConneciton();
            SqlCommand com = new SqlCommand("[UpdateRoasteringOffLeaveManager]", conStr);
            com.CommandType = CommandType.StoredProcedure;

            com.Parameters.Add("@XMLString", SqlDbType.VarChar).Value = XML.ToString();
            ExtraParameterForSecurity.AddExtraParameterForSecurity(ref com, "Roastering Off Updated By Manager");
    ...
    private void SendMail(string IDs)
    {
        ...
        SqlConnection conStr = connection.CreateConneciton();
        SqlCommand Com = new SqlCommand("FetchTLDetailRoasteringOffLeaveDetailForMail", conStr);
        ...
        foreach (DataRow Dr in TLIDs.Rows)
        {
            try
            {
                Com.CommandText = "FetchRoasteringOffLeaveDetailForMail";
                ...
                Email += "        <br />";
                Email += "    <h1>";
                Email += "        Roastering Off Leave Detail";
                Email += "    </h1>";
                ...
                Email += "                        <tr>";
                Email += "                            <td >";
                Email += "Following Is The Detail Of Roastering Off Leave</td>";
                Email += "                        </tr>";
                Email += "                        <tr>";
                Email += "                            <td >";
                ...
                string Result = SendEmailViaSMTP.SendEmail(Dr["MEmailID"].ToString(), Dr["EmailID"].ToString(), "", "Leave Management System : Approved Roastering Off Leave Detail From Manager", Email);
            }
            catch (Exception ee)
            {
                Session["Ex"] = ee.Message.ToString();
