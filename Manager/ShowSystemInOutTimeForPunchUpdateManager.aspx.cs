...
public partial class ShowSystemInOutTimeForPunchUpdateManager : System.Web.UI.Page
{
    ...
    private void BindGrid()
    {
        ...
        SqlCommand com = new SqlCommand("FetchPunchCardDetailTrackingLoginFoundManager", conStr);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection conStr = connection.CreateConneciton();
        SqlCommand com = new SqlCommand("InsertManualAttendancePunchCardUpdateManager", conStr);
        com.CommandType = CommandType.StoredProcedure;


        com.Parameters.Add("@XMLString", SqlDbType.VarChar).Value = XML.ToString();
        com.Parameters.Add("@ManagerID", SqlDbType.Int).Value = Session["LoginID"].ToString();
        com.Parameters.Add("@ManagerComment", SqlDbType.VarChar).Value = txtComment.Text;
