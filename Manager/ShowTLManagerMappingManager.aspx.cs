...
public partial class ShowTLManagerMappingManager : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand com = new SqlCommand("FetchTLManagerMappingForManager", conStr);
    ...
    protected void btnExportToEXCEL_Click(object sender, EventArgs e)
    {
        ...
        ExportToEXCEL.ExportDtToEXCEL(DT, "TLManagerMapping.xls");
