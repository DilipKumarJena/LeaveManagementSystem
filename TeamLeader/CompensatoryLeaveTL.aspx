<%@ Page AutoEventWireup="true" CodeFile="CompensatoryLeaveTL.aspx.cs" Inherits="CompensatoryLeaveTL"
    Language="C#" MasterPageFile="~/MasterPage/MasterPageNew.master" Title="Define Compensatory Leave : Team Leader" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <h1>
                Compensatory Leave : Team Leader</h1>
            <br />
