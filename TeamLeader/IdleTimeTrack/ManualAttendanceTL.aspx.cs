...
public partial class ManualAttendanceTL : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Label1.Text = "";
        SqlConnection conStr = connectionForTracking.CreateConneciton();
        SqlCommand com = new SqlCommand("[FetchMachineAndManualPunchDetailTL]", conStr);
