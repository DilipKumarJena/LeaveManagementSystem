...
public partial class LeaveBalanceTeamLeader : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand com = new SqlCommand("FetchLeaveBalanceTeamLeader", conStr);
    ...
    protected void btnExportToEXCEL_Click(object sender, EventArgs e)
    {
        ...
        ExportToEXCEL.ExportDtToEXCEL(DT, "Team Leave Balance.xls");
