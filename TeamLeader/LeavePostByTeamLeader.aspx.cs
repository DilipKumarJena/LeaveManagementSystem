...
public partial class LeavePostByTeamLeader : System.Web.UI.Page
{
    protected void ddlEmployeeList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        LoginEmployeeID = ddlEmployeeList.SelectedValue;
        ...
        com.Parameters.Add("@ID", SqlDbType.Int).Value = ddlEmployeeList.SelectedValue;
        ...
        try
        {
            ...
            if (EmpDetail.Rows.Count == 1)
            {
                lblMessage.Text = "";
                aMusterRoll.Attributes.Add("href", "../Employee/ShowMusterRoll.aspx?EmpCode=" + EmpDetail.Rows[0]["EMPCode"].ToString() + "");
                ...
                com.CommandText = "FetchLeaveTypeByDesignation";
                com.CommandType = CommandType.StoredProcedure;
                com.Parameters.Clear();


                com.Parameters.Add("@DesignationID", SqlDbType.VarChar, 50).Value = EmpDetail.Rows[0]["DesignationID"].ToString();
            ...
            {
                lblMessage.Text = "Select Employee From List.";
            }
        }
        catch (Exception ee)
        {
    ...
    protected void btnApply_Click(object sender, EventArgs e)
    {
        ...
        com.Parameters.Add("@LeavePostedBy", SqlDbType.Int).Value = Session["LoginID"].ToString();
    ...
    protected string SendMail()
    {
        ...
        Email += "        <br />";
        Email += "    <h1>";
        Email += "        Leave Posted By Team Leader";
        Email += "    </h1>";
        ...
        string Result = SendEmailViaSMTP.SendEmail(EmailIDs.Rows[0]["EmpMailID"].ToString(), EmailIDs.Rows[0]["TLMailID"].ToString(), EmailIDs.Rows[0]["MMailID"].ToString() + "," + EmailIDs.Rows[0]["EmpMailID"].ToString(), "Leave Management System : Leave Posted By Team Leader", Email);
    ...
    private void VoiceEmployee()
    {
        ...
        for (int i = 0; i <= aa.Days; i++)
        {
            ...
            //bool PunchFound = FetchPunchFound(LoginEmployeeID.ToString(), txtFromDate.Text, txtToDate.Text);
    ...
    {
        lblMessage.Text = "";
        DateTime ServerDate = Convert.ToDateTime(lblCurrentDate.Text);
        ...
        for (int i = 0; i <= aa.Days; i++)
        {
            ...
            else
            {
                ...
                //{
                //    if (gvR.Cells[4].Text.ToString() == "C - Compensatory Leave (In Hours)")
                //    {
                ...
                //        A.Attributes.Add("href", "~/Employee/CompensatoryLeaveAdjustment.aspx?S=" + Dr["From"] + "&E=" + Dr["To"] + "&T=" + Dr["HalfFull"] + "&EmpCode=" + LoginEmployeeID + "");
    ...
    protected void gvLeaveDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            else if (e.Row.Cells[4].Text.ToString() == "RoL - Roastering Off Leave (In Hours)")
            {
                ...
                A.Attributes.Add("title", "Roastering Off Leave Adjustment");
                A.Attributes.Add("onMouseOver", "window.status='http://www.oksgroup.com';return true");
                A.InnerText = "Select";
                e.Row.Cells[5].Controls.Add(A);
            }
    ...
    {
        Response.Redirect("../Employee/CompensatoryLeaveDetailForEmployee.aspx?EmployeeID=" + LoginEmployeeID);
    }
