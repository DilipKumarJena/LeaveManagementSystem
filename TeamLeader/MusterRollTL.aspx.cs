...
public partial class MusterRollTL : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand com = new SqlCommand("[ReportPresentAbsentAttendance_MusterRollTeamLeader]", conStr);
    ...
    protected void btnExportToEXCEL_Click(object sender, EventArgs e)
    {
        ...
        ExportToEXCEL.ExportDtToEXCEL(DT, txtStartDate.Text + " To " + txtEndDate.Text + "_" + "MasterRollForTeamLeader.xls");
    ...
    protected void divReport_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        string Width = Session["BrowserWidth"].ToString();
