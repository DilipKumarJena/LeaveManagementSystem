...
public partial class UserControl_LeaveCalendar : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!(IsPostBack))
        {
            ...
            Label1.Text = BuildCalendar(FetchMonthLeave(Session["LoginID"].ToString(), Int32.Parse(ViewState["Month"].ToString()), Int32.Parse(ViewState["Year"].ToString())), Int32.Parse(ViewState["Year"].ToString()), Int32.Parse(ViewState["Month"].ToString()), Session["DepartmentName"].ToString());
    ...
    public string BuildCalendar(DataTable Holidays, int Year, int Month, string Department)
    {
        Label2.Text = "Holiday Calendar " + CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(Month) + " " + Year + " For " + Department + " Department";
    ...
    protected void btnPrevious_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Label1.Text = BuildCalendar(FetchMonthLeave(Session["LoginID"].ToString(), Month, Year), Year, Month, Session["DepartmentName"].ToString());
        ViewState["Month"] = Month;
        ViewState["Year"] = Year;
        //.Text = "Holiday Calenday " + CultureInfo.CurrentCulture.DateTimeFormat.GetMonthName(Month) + " " + Year + " For " + Session["DepartmentName"].ToString() + " Department"; ;
