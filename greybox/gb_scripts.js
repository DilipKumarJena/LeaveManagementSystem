...
document.getElementById('OksLogo').style.visibility='normal';
document.getElementById('Banner').style.visibility='normal';         
      }
            ...
            if(f == "gb_page_center")
            {
               c.onclick = function()
               {
                  ...
                  GB_showCenter(g.caption, g.url, parseInt(h[1]), parseInt(h[0]));
                    document.getElementById('OksLogo').style.visibility='hidden';
...
GB_showImage = function(a, c, e)
{
   var b =
   {
      width : 300, height : 300, type : "image", fullscreen : false, center_win : true, caption : a, callback_fn : e
   }
   ;
...
GB_showPage = function(a, c, e)
{
   var b =
   {
      type : "page", caption : a, callback_fn : e, fullscreen : true, center_win : false
   }
   ;
   var d = new GB_Gallery(b);
   return d.show(c)
...
GB_show = function(b, d, a, e, g)
{
   var c =
   {
      caption : b, height : a || 500, width : e || 500, fullscreen : false, callback_fn : g
   }
   ;
...
GB_showCenter = function(b, d, a, e, g)
{
   var c =
   {
      caption : b, center_win : true, height : a || 500, width : e || 500, fullscreen : false, callback_fn : g
   }
   ;
   var f = new GB_Window(c);
   return f.show(d)
...
GB_showFullScreen = function(a, c, e)
{
   var b =
   {
      caption : a, fullscreen : true, callback_fn : e
   }
   ;
